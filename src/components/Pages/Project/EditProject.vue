  ...
  <div>
    <b-container class="mt-5">
      ...
      <b-form-group class="form-title" :class="{ 'form-group--error': $v.project.name.$error }">
        <b-form-input type="text" class="v-input project-name" v-model.trim="project.name"
        ...
        <small class="form-text text-muted" v-if="!$v.project.name.minLength">Lungimea minima a numelui este de 4
          caractere.</small>
      ...
      <b-form-group class="mt-5" label="Descriere proiect">
        <b-form-input type="text" class="v-input" v-model="project.description"
                      placeholder="Acest camp este optional.."></b-form-input>
      </b-form-group>

      <b-row class="mt-5">
        <b-col md="6">
          <b-form-checkbox v-model="project.authSystem" name="authSystem" switch>Sistem de autentificare
          </b-form-checkbox>
        </b-col>
        <b-col md="6">
      ...
      <b-form-group label="Nume entitate" class="mt-5" v-if="project.authSystem">
        ...
        <small class="form-text text-muted" v-if="!$v.project.userDefinition.required">Alege un nume pentru entitatea ce
          va fi folosita pentru autentificare.</small>
        <small class="form-text text-muted" v-if="!$v.project.userDefinition.$invalid">{{ project.userDefinition }} pare
          a fi un nume bun.</small>
      </b-form-group>
      ...
      <b-form-group label="Cheia de acces" class="mt-5" v-if="project.useApiKey">
        <b-form-input type="text" class="v-input" placeholder='Scrie "random" pentru a genera o cheie...'
                      v-model.trim="project.apiKey"></b-form-input>
      </b-form-group>
  ...
  export default {
    ...
    methods: {
      saveProject() {
        ...
        this.$notify('Proiectul a fost salvat.')
      }
    },
    validations: {
      project: {
